...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-C0C7gP9d.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-TJ1S60ot.js").then((n2) => n2.r),
...
var ROUTER_BASEPATH = "Research-Website-AgroMind";
var SERVER_FN_BASE = "/Research-Website-AgroMind/_serverFn/";
